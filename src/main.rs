...
use mipidsi::{Builder, interface::SpiInterface, models::ILI9225Rgb565, options::Orientation};
...
fn render_system(mut prev_time: Local<u64>, mut prev_update_time: Local<u64>) {
    ...
    *prev_update_time = time;
    ...
    embedded_graphics::primitives::Rectangle::new(Point::new(10, 10), Size::new(200, 156))
        .draw_styled(
